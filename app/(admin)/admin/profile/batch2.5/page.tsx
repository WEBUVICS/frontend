...
const advisors: Member[] = [
  { id: 1, name: "Sir. Stenly Pungus Ph.D", title: "Advisor", batch: "Batch 2.5", image: null },
];

const coreTeam: Member[] = [
  { id: 1, name: "Aiko Lasut", title: "President", batch: "Batch 2.5", image: null },
  { id: 2, name: "Prince Tampi", title: "Vice President", batch: "Batch 2.5", image: null },
  { id: 3, name: "Dion Kobi", title: "Secretary", batch: "Batch 2.5", image: null },
];

const webDevelopment: Member[] = [
  { id: 1, name: "Grantly Sorongan", title: "Web Development", batch: "Batch 2.5", image: null },
  { id: 2, name: "Adithia Gunawan", title: "Web Development", batch: "Batch 2.5", image: null },
  { id: 3, name: "Jordan Sutarto", title: "Web Development", batch: "Batch 2.5", image: null },
];

const Indev: Member[] = [
  { id: 1, name: "Marshanda Padmarini", title: "Editor", batch: "Batch 2.5", image: null },
  { id: 2, name: "Avriel Parengkuan", title: "Indev", batch: "Batch 2.5", image: null },
  { id: 3, name: "Alyan Donuhulu", title: "Exaf", batch: "Batch 2.5", image: null },
];

const Editor: Member[] = [
  { id: 1, name: "John Doe", title: "Editor", batch: "Batch 2.5", image: null },
  { id: 2, name: "Jane Doe", title: "Editor", batch: "Batch 2.5", image: null },
];

const PR: Member[] = [
  { id: 1, name: "Alex Smith", title: "PR Coordinator", batch: "Batch 2.5", image: null },
  { id: 2, name: "Emily Johnson", title: "PR Staff", batch: "Batch 2.5", image: null },
];

const batches = ["Batch 1", "Batch 2", "Batch 2.5"];

export default function AdvisorCarousel() {
  const [selectedBatch, setSelectedBatch] = React.useState("Batch 2.5");
