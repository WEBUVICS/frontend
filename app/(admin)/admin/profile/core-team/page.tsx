...
const coreTeam: Member[] = [
  ...
  { id: 4, name: "Aiko Lasut", title: "President", batch: "Batch 1", image: null },
  { id: 5, name: "Prince Tampi", title: "Vice President", batch: "Batch 1", image: null },
  { id: 6, name: "Dion Kobi", title: "Secretary", batch: "Batch 1", image: null },
];
...
export default function CoreTeamPage() {
  return (
    <div className="p-4 sm:p-6 lg:p-8">
      ...
      <h1 className="text-2xl sm:text-3xl font-semibold text-orange-500 mb-5">Core Team</h1>
