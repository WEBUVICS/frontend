...
const publicDocTeam: Member[] = [
  ...
  { id: 4, name: "Marshanda Padmarini", title: "PnD", batch: "Batch 1", image: null },
  { id: 5, name: "Avriel Parengkuan", title: "PnD", batch: "Batch 1", image: null },
  { id: 6, name: "Alyan Donuhulu", title: "PnD", batch: "Batch 1", image: null },
];
...
export default function PublicDocumentationPage() {
  return (
    <div className="p-4 sm:p-6 lg:p-8">
      ...
      <h1 className="text-2xl sm:text-3xl font-semibold text-orange-500 mb-5">Public & Documentation</h1>

      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
        {publicDocTeam.map((member) => (
          <Card
            key={member.id}
