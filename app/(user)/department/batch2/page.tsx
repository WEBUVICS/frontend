...
export default function DepartmentUvics() {
  ...
  { id: 4, name: "John Doe", position: "Member INDEV", image: "" },
  { id: 5, name: "John Doe", position: "Member INDEV", image: "" },
  { id: 6, name: "John Doe", position: "Member INDEV", image: "" },
  { id: 7, name: "John Doe", position: "Member INDEV", image: "" },
  { id: 8, name: "John Doe", position: "Member INDEV", image: "" },
];

const exafMembers = [
  { id: 1, name: "John Doe", position: "PIC EXAF", image: "" },
  { id: 2, name: "John Doe", position: "PIC EXAF", image: "" },
  { id: 3, name: "John Doe", position: "Koordinator", image: "" },
  { id: 4, name: "John Doe", position: "Member EXAF", image: "" },
  { id: 5, name: "John Doe", position: "Member EXAF", image: "" },
  { id: 6, name: "John Doe", position: "Member EXAF", image: "" },
  { id: 7, name: "John Doe", position: "Member EXAF", image: "" },
  { id: 8, name: "John Doe", position: "Member EXAF", image: "" },
];
...
const editorMembers = [
  ...
  { id: 3, name: "John Doe", position: "Koordinator", image: "" },
  { id: 4, name: "John Doe", position: "Member Editor", image: "" },
  { id: 5, name: "John Doe", position: "Member Editor", image: "" },
  { id: 6, name: "John Doe", position: "Member Editor", image: "" },
  { id: 7, name: "John Doe", position: "Member Editor", image: "" },
...
const prMembers = [
  ...
  { id: 3, name: "John Doe", position: "Koordinator", image: "" },
  { id: 4, name: "John Doe", position: "Member PR", image: "" },
  { id: 5, name: "John Doe", position: "Member PR", image: "" },
  { id: 6, name: "John Doe", position: "Member PR", image: "" },
  { id: 7, name: "John Doe", position: "Member PR", image: "" },
...
const comhandmembers = [
  ...
  const MemberCard = ({ member }: { member: any }) => (
    <div className="flex flex-col items-center bg-white shadow-lg w-full gap-12 sm:w-32 md:w-40 lg:w-44 xl:w-48 h-44 sm:h-52 md:h-60 lg:h-64 overflow-hidden hover:scale-105 transition-transform duration-300">
...
{/* === EXAF === */}
<div className="mt-10 sm:mt-20 w-full flex flex-col items-center text-center">
  <h2 className="text-lg sm:text-2xl md:text-3xl font-bold text-[#FFA447] mb-2">EXAF</h2>
